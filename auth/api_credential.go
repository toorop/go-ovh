...
func (m *APICredential) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateLastUse(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *APICredential) validateExpiration(formats strfmt.Registry) error {
...
func (m *APICredential) validateLastUse(formats strfmt.Registry) error {

	if swag.IsZero(m.LastUse) { // not required
		return nil
	}

	if err := validate.FormatOf("lastUse", "body", "date-time", m.LastUse.String(), formats); err != nil {
		return err
	}
