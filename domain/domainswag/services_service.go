...
func (m *ServicesService) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateEngagedUpTo(formats); err != nil {
		// prop
		res = append(res, err)
	}
...
func (m *ServicesService) validateEngagedUpTo(formats strfmt.Registry) error {

	if swag.IsZero(m.EngagedUpTo) { // not required
		return nil
	}

	if err := validate.FormatOf("engagedUpTo", "body", "date", m.EngagedUpTo.String(), formats); err != nil {
		return err
	}
